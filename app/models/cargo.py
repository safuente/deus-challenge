...
class Cargo(Base):
    ...
    description: str = Column(String, nullable=False, doc="Description of the cargo contents.")
    weight: float = Column(Float, nullable=False, doc="Weight of the cargo in kilograms.")
    volume: float = Column(Float, nullable=False, doc="Volume of the cargo in cubic meters.")
    contract_id: int = Column(Integer, ForeignKey("contracts.contract_id", ondelete="CASCADE"), nullable=False,
